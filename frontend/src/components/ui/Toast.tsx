...
export function Toast({ message, type }: ToastProps) {
  return (
    <div className={`fixed top-8 right-8 px-6 py-4 rounded-2xl border font-bold shadow-2xl transition-all z-[100] flex items-center gap-3 animate-in slide-in-from-top-5 fade-in duration-300 ${
      type === 'success' 
